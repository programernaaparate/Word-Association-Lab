...
export const DEFAULT_ASSOCIATION_WORDS = [
  association(1, 'Atom', 'Nauka', 'Lako', ['Jezgro', 'Elektron', 'Hemija', 'Cestica'], 'Osnovna jedinica materije.', ['atom'], '⚛️'),
  association(2, 'Galaksija', 'Nauka', 'Srednje', ['Zvijezde', 'Svemir', 'Orbita', 'Mlijecni put'], 'Ogromna grupa zvijezda i kosmickog materijala.', ['galaksija'], '🌌'),
  ...
  association(25, 'Celija', 'Nauka', 'Lako', ['Membrana', 'Jezgro', 'Tkivo', 'Organizam'], 'Osnovna jedinica zivih bica.', ['celija', 'celija']),
  ...
  association(28, 'Stafeta', 'Sport', 'Srednje', ['Tim', 'Palica', 'Predaja', 'Trka'], 'Trka u kojoj clanovi tima predaju palicu.', ['stafeta', 'stafeta']),
  association(29, 'Zanr', 'Film', 'Lako', ['Drama', 'Komedija', 'Horor', 'Vrsta'], 'Vrsta filma ili knjizevnog djela.', ['zanr', 'zanr']),
  association(30, 'Rezija', 'Film', 'Tesko', ['Vizija', 'Set', 'Kamera', 'Reditelj'], 'Vodjenje i oblikovanje filmskog djela.', ['rezija', 'rezija']),
  association(31, 'Cirilica', 'Istorija', 'Srednje', ['Slova', 'Pismo', 'Azbuka', 'Vuk'], 'Jedno od osnovnih slovenskih pisama.', ['cirilica', 'cirilica']),
  association(32, 'Pecina', 'Priroda', 'Lako', ['Stijena', 'Mrak', 'Podzemlje', 'Kapljice'], 'Prirodna supljina u stijeni.', ['pecina', 'pecina']),
  association(33, 'Suma', 'Priroda', 'Srednje', ['Drvece', 'Lisce', 'Staza', 'Zivotinje'], 'Veliko podrucje obraslo drvecem.', ['suma', 'suma']),
  association(34, 'Pozoriste', 'Umjetnost', 'Lako', ['Scena', 'Glumci', 'Publika', 'Predstava'], 'Mjesto i umjetnost izvodjenja predstava.', ['pozoriste', 'pozoriste']),
  association(35, 'Racunar', 'Tehnologija', 'Lako', ['Tastatura', 'Ekran', 'Procesor', 'Mis'], 'Elektronski uredjaj za obradu podataka.', ['racunar', 'racunar', 'kompjuter']),
  association(36, 'Mreza', 'Tehnologija', 'Srednje', ['Internet', 'Signal', 'Povezivanje', 'Server'], 'Sistem povezanih uredjaja i veza.', ['mreza', 'mreza']),
  association(37, 'Usce', 'Geografija', 'Srednje', ['Rijeka', 'More', 'Ulivanje', 'Delta'], 'Mjesto gdje se rijeka uliva u vecu vodenu povrsinu.', ['usce', 'usce']),
  association(38, 'Poluostrvo', 'Geografija', 'Tesko', ['Kopno', 'More', 'Rt', 'Obala'], 'Kopno okruzeno morem sa tri strane.', ['poluostrvo']),
]
...
export const DEFAULT_LOGIC_CHALLENGES = [
  ...
  logic(21, 'concept', ['Automatika', 'Senzor', 'Masina'], 'Robotika', 'Rijesenje je tehnoloska oblast.', 'Tehnologija', 'Tesko', ['robotika', 'nauka o robotima']),
  logic(22, 'concept', ['Drzava', 'Granica', 'Kontinent'], 'Geografija', 'Povezi pojmove sa naukom o prostoru Zemlje.', 'Geografija', 'Lako', ['geografija', 'nauka o zemlji']),
  ...
  logic(25, 'concept', ['Membrana', 'Jezgro', 'Tkivo'], 'Celija', 'Povezi pojmove sa osnovnom jedinicom zivota.', 'Nauka', 'Lako', ['celija', 'celija']),
  logic(26, 'odd-one-out', ['Kiseonik', 'Azot', 'Vodonik', 'Pozoriste'], 'Pozoriste', 'Tri pojma su hemijski elementi ili gasovi.', 'Nauka', 'Srednje'),
  logic(27, 'concept', ['Palica', 'Predaja', 'Tim'], 'Stafeta', 'Rjesenje je trkacka disciplina sa vise takmicara.', 'Sport', 'Srednje', ['stafeta', 'stafeta', 'stafetna trka']),
  logic(28, 'concept', ['Sedmerac', 'Golman', 'Dvorana'], 'Rukomet', 'Rjesenje je ekipni sport koji se igra rukama.', 'Sport', 'Lako', ['rukomet', 'handball']),
  logic(29, 'concept', ['Drama', 'Komedija', 'Horor'], 'Zanr', 'Sve rijeci predstavljaju vrste istog umjetnickog pojma.', 'Film', 'Lako', ['zanr', 'zanr', 'vrsta filma', 'filmski zanr']),
  logic(30, 'odd-one-out', ['Kamera', 'Reditelj', 'Kadar', 'Cempres'], 'Cempres', 'Tri pojma pripadaju filmu, jedan prirodi.', 'Film', 'Tesko'),
  logic(31, 'concept', ['Slova', 'Azbuka', 'Pismo'], 'Cirilica', 'Rjesenje je jedno pismo.', 'Istorija', 'Srednje', ['cirilica', 'cirilica', 'azbuka']),
  logic(32, 'odd-one-out', ['Suma', 'Pecina', 'Planina', 'Lozinka'], 'Lozinka', 'Tri pojma pripadaju prirodi.', 'Priroda', 'Lako'),
  logic(33, 'concept', ['Scena', 'Glumci', 'Publika'], 'Pozoriste', 'Rjesenje povezuje izvodjenje predstava.', 'Umjetnost', 'Lako', ['pozoriste', 'pozoriste', 'teatar']),
  logic(34, 'concept', ['Tastatura', 'Procesor', 'Mis'], 'Racunar', 'Rjesenje je uredjaj kojem svi pojmovi pripadaju.', 'Tehnologija', 'Lako', ['racunar', 'racunar', 'kompjuter', 'komputer']),
  logic(35, 'concept', ['Internet', 'Signal', 'Povezivanje'], 'Mreza', 'Rjesenje oznacava povezan sistem uredjaja.', 'Tehnologija', 'Srednje', ['mreza', 'mreza', 'racunarska mreza']),
  logic(36, 'concept', ['Rijeka', 'More', 'Ulivanje'], 'Usce', 'Rjesenje je geografski pojam za zavrsetak toka rijeke.', 'Geografija', 'Srednje', ['usce', 'usce', 'rijecno usce']),
]
...
export const DEFAULT_RELATION_CHALLENGES = [
  ...
  relation(25, 'Tacnost', 'Preciznost', 'Sinonim', 'Nauka', 'Lako', 'Rijeci opisuju vrlo slicnu osobinu mjerenja ili rada.'),
  relation(26, 'Ziv', 'Mrtav', 'Antonim', 'Nauka', 'Srednje', 'Pojmovi imaju potpuno suprotno znacenje.'),
  relation(27, 'Celija', 'Tkivo', 'Asocijacija', 'Nauka', 'Tesko', 'Jedan pojam je sastavni dio drugog.'),
  relation(28, 'Stafeta', 'Palica', 'Asocijacija', 'Sport', 'Lako', 'Bez jednog pojma drugi tesko moze da se zamisli u trci.'),
  relation(29, 'Pobjeda', 'Trijumf', 'Sinonim', 'Sport', 'Srednje', 'Oba pojma znace uspjesan ishod.'),
  relation(30, 'Rukomet', 'Dvorana', 'Asocijacija', 'Sport', 'Tesko', 'Pojmovi se prirodno vezuju za isti sport.'),
  relation(31, 'Zanr', 'Vrsta', 'Sinonim', 'Film', 'Lako', 'U ovom kontekstu rijeci znace skoro isto.'),
  relation(32, 'Tisina', 'Galama', 'Antonim', 'Umjetnost', 'Srednje', 'Jedan pojam iskljucuje drugi.'),
  relation(33, 'Pozoriste', 'Predstava', 'Asocijacija', 'Umjetnost', 'Tesko', 'Jedan pojam se izvodi u drugom.'),
  relation(34, 'Racunar', 'Kompjuter', 'Sinonim', 'Tehnologija', 'Lako', 'Oba pojma oznacavaju isti uredjaj.'),
  relation(35, 'Sifra', 'Lozinka', 'Sinonim', 'Tehnologija', 'Srednje', 'Rijeci se koriste za slican zastitni pojam.'),
  relation(36, 'Usce', 'Delta', 'Asocijacija', 'Geografija', 'Tesko', 'Pojmovi su povezani sa zavrsetkom rijecnog toka.'),
]
